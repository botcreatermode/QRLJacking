...
====================
![](https://github.com/botcreatermode/QRLJacking/blob/master/blob/images/QRLJacking.JPG?raw=true)
...
Find documentation in our [Wiki](https://github.com/botcreatermode/QRLJacking/wiki).
## What is QRLJacking?
...
Using QRLJacker - [QRLJacking Exploitation Framework](https://github.com/botcreatermode/QRLJacking/tree/master/QRLJacker)


## Technical Paper
The technical paper clarifying everything about the QRLJacking attack vector can be found directly via our [Wiki](https://github.com/botcreatermode/QRLJacking/wiki).
...
[Mohamed Abdelbasset Elnouby (@botcreatermode)](https://github.com/botcreatermode)

Guru.Bhaai@botcreatermode.org
